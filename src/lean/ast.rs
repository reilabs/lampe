...
pub enum LValue {
    ...
    Index { array: Box<LValue>, index: Expression, typ: Type },
...
impl Type {
    ...
    pub fn fmt_string(args: TypeExpr) -> Self {
        Type {
            expr: TypeExpr::builtin(BuiltinTag::FmtString, &[args]),
            kind: Kind::Type,
        }
    }
    ...
    #[must_use]
    pub fn tuple(elems: &[TypeExpr]) -> Self {
        Type {
...
impl TypeExpr {
    #[must_use]
    pub fn builtin(tag: BuiltinTag, generics: &[TypeExpr]) -> Self {
