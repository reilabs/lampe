...
pub enum Error {
    ...
    MissingDependencyError{package_name: String, package_version: Option<String>, dependency_name: String},
    ...
    URLParsingError{package_name: String, package_version: Option<String>, dependency_name: String, err: String},
}
