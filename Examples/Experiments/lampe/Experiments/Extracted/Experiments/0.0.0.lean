...
def env := Lampe.Env.mk [«cast_test», «Option2::none», «string_test», «check», «Option2::some», «fmtstr_test», «tuple_test», «my_fn», «my_func», «Option2::is_some», «is_alias_some», «Option2::is_none», «assigns», «my_func2», «my_func3», «uncons», «get_unchecked», «main», «literal_test»] [impl_406, impl_405, impl_407]