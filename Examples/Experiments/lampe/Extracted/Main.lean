...
nr_def «main»<>() -> Unit {
    ...
    tpl.0 = 2 : Field;
    let impl_res = (@impl_test<μ1, μ0> as λ(Option2<Field>, Field) → bool)(op1, 0 : Field);
...
def env := Lampe.Env.mk [«string_test», «tuple_test», «cast_test», «my_func2», «impl_test», «check», «get_unchecked», «Option2::is_none», «assigns», «Option2::is_some», «main», «is_alias_some», «my_func3», «Option2::some», «literal_test», «my_fn», «Option2::none», «fmtstr_test», «my_func»] [impl_406, impl_407, impl_405]