...
@[reducible]
def replaceVector' (s : Tp.denote p $ .vector tp) (i : Fin s.length) (v : Tp.denote p tp) : Tp.denote p $ .vector tp :=
  List.modify s i (fun _ => v)

@[simp]
theorem replaceVector_length_eq_length :
...
/--
Defines the builtin for repeated vectors
-/
...
list; see `Builtin.mkValArray` for the rationale.
-/
...
@[deprecated mkVector (since := "2025-03-19")] abbrev mkSlice := @mkVector
@[deprecated mkRepeatedVector (since := "2025-03-19")] abbrev mkRepeatedSlice := @mkRepeatedVector
@[deprecated vectorIndex (since := "2025-03-19")] abbrev sliceIndex := @vectorIndex
@[deprecated vectorPushBack (since := "2025-03-19")] abbrev slicePushBack := @vectorPushBack
@[deprecated vectorPushFront (since := "2025-03-19")] abbrev slicePushFront := @vectorPushFront
@[deprecated vectorInsert (since := "2025-03-19")] abbrev sliceInsert := @vectorInsert
@[deprecated vectorPopFront (since := "2025-03-19")] abbrev slicePopFront := @vectorPopFront
@[deprecated vectorPopBack (since := "2025-03-19")] abbrev slicePopBack := @vectorPopBack
@[deprecated vectorRemove (since := "2025-03-19")] abbrev sliceRemove := @vectorRemove
