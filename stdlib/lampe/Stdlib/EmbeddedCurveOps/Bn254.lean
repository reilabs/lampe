...
scalar-field prime (`Bn254.prime`) and discharges the encoded-input
...
open Lampe Lampe.Crypto Lampe.Stdlib.Field.Bn254 Lampe.Crypto.EmbeddedCurve

private theorem bn254_generator_nonsingular :
    (affineCurve Bn254.prime).Nonsingular 1
      (17631683881184975370165255887551781615748388533673675138860 : Fp Bn254.prime) := by
  native_decide
...
@[simp] theorem generator_eq_encodeCurvePoint :
    (Lampe.Stdlib.EmbeddedCurveOps.Point.generator
      : Lampe.Stdlib.EmbeddedCurveOps.Point.denote Bn254.prime) =
