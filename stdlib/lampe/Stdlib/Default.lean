...
@[reducible]
def default {p}
    (generics : HList Kind.denote «std-1.0.0-beta.25::default::Default».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std-1.0.0-beta.25::default::Default».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std-1.0.0-beta.25::default::Default».default.«#genericKinds»)
  : HList (Tp.denote p)
      («std-1.0.0-beta.25::default::Default».default.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std-1.0.0-beta.25::default::Default».default.«#output» generics Self associatedTypes fnGenerics) :=
  «std-1.0.0-beta.25::default::Default».default generics Self associatedTypes fnGenerics

/--
Asserts that the provided `tp` has an implementation of `std::default::Default` in the environment.
-/
@[reducible]
def hasDefaultImpl (env : Env) (tp : Tp) := «std-1.0.0-beta.25::default::Default».hasImpl env h![] tp
