...
noir_trait_impl[impl_62]<T: Type> std::default::Default<> for std::option::Option<T> where [] := {
  noir_def default<>() -> std::option::Option<T> := {
    (std::option::Option::none<> as λ() -> std::option::Option<T>)()
  };
}

noir_trait_impl[impl_63]<T: Type> std::cmp::Eq<> for std::option::Option<T> where [T: std::cmp::Eq<>] := {
...
noir_trait_impl[impl_64]<T: Type> std::hash::Hash<> for std::option::Option<T> where [T: std::hash::Hash<>] := {
...
noir_trait_impl[impl_65]<T: Type> std::cmp::Ord<> for std::option::Option<T> where [T: std::cmp::Ord<>] := {
...
def Option.env : Env := Env.mk
  ...
  [impl_62, impl_63, impl_64, impl_65]
