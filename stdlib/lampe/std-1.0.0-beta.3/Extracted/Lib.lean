...
noir_def verify_proof<N: u32, M: u32, K: u32>(verification_key: Array<Field, N: u32>, proof: Array<Field, M: u32>, public_inputs: Array<Field, K: u32>, key_hash: Field) -> Unit := {
  (verify_proof_internal<N: u32, M: u32, K: u32> as λ(Array<Field, N: u32>, Array<Field, M: u32>, Array<Field, K: u32>, Field, u32) -> Unit)(verification_key, proof, public_inputs, key_hash, (0: u32));
  #_skip
}
...
def Lib.env : Env := Env.mk
  [print_oracle, print_unconstrained, println, print, verify_proof, verify_proof_with_type, verify_proof_internal, assert_constant, static_assert, wrapping_add, wrapping_sub, wrapping_mul, as_witness, «tests::test_static_assert_custom_message», «tests::test_wrapping_mul»]
  []
