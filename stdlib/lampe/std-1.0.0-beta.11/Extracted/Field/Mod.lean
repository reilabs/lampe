...
noir_def «std-1.0.0-beta.11»::field::to_le_bits<N: u32>(self: Field) -> Array<u1, N: u32> := {
...
noir_def «std-1.0.0-beta.11»::field::to_be_bits<N: u32>(self: Field) -> Array<u1, N: u32> := {
...
noir_def «std-1.0.0-beta.11»::field::to_le_bytes<N: u32>(self: Field) -> Array<u8, N: u32> := {
  ...
  let bytes = («std-1.0.0-beta.11»::field::to_le_radix<N: u32> as λ(Field, u32) -> Array<u8, N: u32>)(self, (256: u32));
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
...
noir_def «std-1.0.0-beta.11»::field::to_be_bytes<N: u32>(self: Field) -> Array<u8, N: u32> := {
  (#_staticAssert returning Unit)((#_uLeq returning bool)(uConst!(N: u32), (#_arrayLen returning u32)((#_modulusLeBytes returning Slice<u8>)())), "N must be less than or equal to modulus_le_bytes().len()");
  let bytes = («std-1.0.0-beta.11»::field::to_be_radix<N: u32> as λ(Field, u32) -> Array<u8, N: u32>)(self, (256: u32));
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
...
noir_def «std-1.0.0-beta.11»::field::to_le_radix<N: u32>(self: Field, radix: u32) -> Array<u8, N: u32> := {
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
...
noir_def «std-1.0.0-beta.11»::field::to_be_radix<N: u32>(self: Field, radix: u32) -> Array<u8, N: u32> := {
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
    (#_staticAssert returning Unit)((#_uLt returning bool)((1: u32), radix), "radix must be greater than 1");
    (#_staticAssert returning Unit)((#_uLeq returning bool)(radix, (256: u32)), "radix must be less than or equal to 256");
    (#_staticAssert returning Unit)((#_uEq returning bool)((#_uAnd returning u32)(radix, (#_uSub returning u32)(radix, (1: u32))), (0: u32)), "radix must be a power of 2");
...
noir_def «std-1.0.0-beta.11»::field::pow_32<>(self: Field, exponent: Field) -> Field := {
  let mut r = (1: Field);
  let b = («std-1.0.0-beta.11»::field::to_le_bits<32: u32> as λ(Field) -> Array<u1, 32: u32>)(exponent);
...
noir_def «std-1.0.0-beta.11»::field::sgn0<>(self: Field) -> u1 := {
  (#_cast returning u1)(self)
}

noir_def «std-1.0.0-beta.11»::field::lt<>(self: Field, another: Field) -> bool := {
  if («std-1.0.0-beta.11»::compat::is_bn254<> as λ() -> bool)() then {
    («std-1.0.0-beta.11»::field::bn254::lt<> as λ(Field, Field) -> bool)(self, another)
  } else {
    («std-1.0.0-beta.11»::field::lt_fallback<> as λ(Field, Field) -> bool)(self, another)
  }
}

noir_def «std-1.0.0-beta.11»::field::from_le_bytes<N: u32>(bytes: Array<u8, N: u32>) -> Field := {
  (#_staticAssert returning Unit)((#_uLeq returning bool)(uConst!(N: u32), (#_arrayLen returning u32)((#_modulusLeBytes returning Slice<u8>)())), "N must be less than or equal to modulus_le_bytes().len()");
  let mut v = (1: Field);
...
noir_def «std-1.0.0-beta.11»::field::from_be_bytes<N: u32>(bytes: Array<u8, N: u32>) -> Field := {
  let mut v = (1: Field);
  let mut result = (0: Field);
  for i in (0: u32) .. uConst!(N: u32) do {
...
noir_def «std-1.0.0-beta.11»::field::__field_less_than<>(x: Field, y: Field) -> bool := {
  (#_fresh returning bool)()
}

noir_def «std-1.0.0-beta.11»::field::field_less_than<>(x: Field, y: Field) -> bool := {
  (#_fresh returning bool)()
}

noir_def «std-1.0.0-beta.11»::field::bytes32_to_field<>(bytes32: Array<u8, 32: u32>) -> Field := {
  let mut v = (1: Field);
...
noir_def «std-1.0.0-beta.11»::field::lt_fallback<>(x: Field, y: Field) -> bool := {
  if (#_isUnconstrained returning bool)() then {
    («std-1.0.0-beta.11»::field::field_less_than<> as λ(Field, Field) -> bool)(x, y)
  } else {
    let x_bytes = («std-1.0.0-beta.11»::field::to_le_bytes<32: u32> as λ(Field) -> Array<u8, 32: u32>)(x);
    let y_bytes = («std-1.0.0-beta.11»::field::to_le_bytes<32: u32> as λ(Field) -> Array<u8, 32: u32>)(y);
...
noir_def «std-1.0.0-beta.11»::field::tests::test_to_be_bits<>() -> Unit := {
  let field = (2: Field);
  let bits = («std-1.0.0-beta.11»::field::to_be_bits<8: u32> as λ(Field) -> Array<u1, 8: u32>)(field);
  (#_assert returning Unit)(((Array<u1, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u1, 8: u32>, Array<u1, 8: u32>) -> bool)(bits, (#_mkArray returning Array<u1, 8: u32>)((0: u1), (0: u1), (0: u1), (0: u1), (0: u1), (0: u1), (1: u1), (0: u1))));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_bits<>() -> Unit := {
  let field = (2: Field);
  let bits = («std-1.0.0-beta.11»::field::to_le_bits<8: u32> as λ(Field) -> Array<u1, 8: u32>)(field);
  (#_assert returning Unit)(((Array<u1, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u1, 8: u32>, Array<u1, 8: u32>) -> bool)(bits, (#_mkArray returning Array<u1, 8: u32>)((0: u1), (1: u1), (0: u1), (0: u1), (0: u1), (0: u1), (0: u1), (0: u1))));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_be_bytes<>() -> Unit := {
  let field = (2: Field);
  let bytes = («std-1.0.0-beta.11»::field::to_be_bytes<8: u32> as λ(Field) -> Array<u8, 8: u32>)(field);
  (#_assert returning Unit)(((Array<u8, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, 8: u32>, Array<u8, 8: u32>) -> bool)(bytes, (#_mkArray returning Array<u8, 8: u32>)((0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (2: u8))));
  (#_assert returning Unit)((#_fEq returning bool)((«std-1.0.0-beta.11»::field::from_be_bytes<8: u32> as λ(Array<u8, 8: u32>) -> Field)(bytes), field));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_bytes<>() -> Unit := {
  let field = (2: Field);
  let bytes = («std-1.0.0-beta.11»::field::to_le_bytes<8: u32> as λ(Field) -> Array<u8, 8: u32>)(field);
  (#_assert returning Unit)(((Array<u8, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, 8: u32>, Array<u8, 8: u32>) -> bool)(bytes, (#_mkArray returning Array<u8, 8: u32>)((2: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8))));
  (#_assert returning Unit)((#_fEq returning bool)((«std-1.0.0-beta.11»::field::from_le_bytes<8: u32> as λ(Array<u8, 8: u32>) -> Field)(bytes), field));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_be_radix<>() -> Unit := {
  let field = (259: Field);
  let bytes = («std-1.0.0-beta.11»::field::to_be_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (256: u32));
  (#_assert returning Unit)(((Array<u8, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, 8: u32>, Array<u8, 8: u32>) -> bool)(bytes, (#_mkArray returning Array<u8, 8: u32>)((0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (1: u8), (3: u8))));
  (#_assert returning Unit)((#_fEq returning bool)((«std-1.0.0-beta.11»::field::from_be_bytes<8: u32> as λ(Array<u8, 8: u32>) -> Field)(bytes), field));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_radix<>() -> Unit := {
  let field = (259: Field);
  let bytes = («std-1.0.0-beta.11»::field::to_le_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (256: u32));
  (#_assert returning Unit)(((Array<u8, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, 8: u32>, Array<u8, 8: u32>) -> bool)(bytes, (#_mkArray returning Array<u8, 8: u32>)((3: u8), (1: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8), (0: u8))));
  (#_assert returning Unit)((#_fEq returning bool)((«std-1.0.0-beta.11»::field::from_le_bytes<8: u32> as λ(Array<u8, 8: u32>) -> Field)(bytes), field));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_radix_1<>() -> Unit := {
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
    let field = (2: Field);
    let _ = («std-1.0.0-beta.11»::field::to_le_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (1: u32));
    #_skip
  } else {
    («std-1.0.0-beta.11»::panic::panic<Tuple<>, Unit, 28: u32> as λ(FmtString<28: u32, Tuple<> >) -> Unit)((#_mkFormatString returning FmtString<28: u32, Tuple<> >)("radix must be greater than 1"));
    #_skip
  }
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_radix_3<>() -> Unit := {
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
    let field = (2: Field);
    let _ = («std-1.0.0-beta.11»::field::to_le_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (3: u32));
    #_skip
  } else {
    («std-1.0.0-beta.11»::panic::panic<Tuple<>, Unit, 26: u32> as λ(FmtString<26: u32, Tuple<> >) -> Unit)((#_mkFormatString returning FmtString<26: u32, Tuple<> >)("radix must be a power of 2"));
    #_skip
  }
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_radix_brillig_3<>() -> Unit := {
  if (#_isUnconstrained returning bool)() then {
    let field = (1: Field);
    let out = («std-1.0.0-beta.11»::field::to_le_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (3: u32));
    let mut expected = (#_mkRepeatedArray returning Array<u8, 8: u32>)((0: u8));
    (expected[(0: u32)]: u8) = (1: u8);
    (#_assert returning Unit)(((Array<u8, 8: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, 8: u32>, Array<u8, 8: u32>) -> bool)(out, expected));
    #_skip
  }
}

noir_def «std-1.0.0-beta.11»::field::tests::test_to_le_radix_512<>() -> Unit := {
  if (#_bNot returning bool)((#_isUnconstrained returning bool)()) then {
    let field = (2: Field);
    let _ = («std-1.0.0-beta.11»::field::to_le_radix<8: u32> as λ(Field, u32) -> Array<u8, 8: u32>)(field, (512: u32));
    #_skip
  } else {
    («std-1.0.0-beta.11»::panic::panic<Tuple<>, Unit, 39: u32> as λ(FmtString<39: u32, Tuple<> >) -> Unit)((#_mkFormatString returning FmtString<39: u32, Tuple<> >)("radix must be less than or equal to 256"))
  }
}

noir_def «std-1.0.0-beta.11»::field::tests::not_enough_limbs_brillig<>() -> Unit := {
  (#_fresh returning Unit)()
}

noir_def «std-1.0.0-beta.11»::field::tests::not_enough_limbs<>() -> Unit := {
  let _ = («std-1.0.0-beta.11»::field::to_le_bytes<16: u32> as λ(Field) -> Array<u8, 16: u32>)((340282366920938463463374607431768211456: Field));
  #_skip
}

noir_def «std-1.0.0-beta.11»::field::tests::test_field_less_than<>() -> Unit := {
  (#_fresh returning Unit)()
}
