...
noir_trait_impl[«std-1.0.0-beta.11».impl_91]<N: u32, T: Type> «std-1.0.0-beta.11»::cmp::Eq<> for Array<T, N: u32> where [T: «std-1.0.0-beta.11»::cmp::Eq<>] := {
  noir_def eq<>(self: Array<T, N: u32>, other: Array<T, N: u32>) -> bool := {
    ...
    for i in (0: u32) .. (#_arrayLen returning u32)(self) do {
      result = (#_bAnd returning bool)(result, ((T as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(T, T) -> bool)((#_arrayIndex returning T)(self, (#_cast returning u32)(i)), (#_arrayIndex returning T)(other, (#_cast returning u32)(i))));
      #_skip
    };
    result
  };
...
noir_trait_impl[«std-1.0.0-beta.11».impl_92]<T: Type> «std-1.0.0-beta.11»::cmp::Eq<> for Slice<T> where [T: «std-1.0.0-beta.11»::cmp::Eq<>] := {
  noir_def eq<>(self: Slice<T>, other: Slice<T>) -> bool := {
    ...
    if result then {
      for i in (0: u32) .. (#_arrayLen returning u32)(self) do {
        result = (#_bAnd returning bool)(result, ((T as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(T, T) -> bool)((#_sliceIndex returning T)(self, (#_cast returning u32)(i)), (#_sliceIndex returning T)(other, (#_cast returning u32)(i))));
        #_skip
      };
      #_skip
    };
...
noir_trait_impl[«std-1.0.0-beta.11».impl_93]<N: u32> «std-1.0.0-beta.11»::cmp::Eq<> for String<N: u32> where [] := {
  noir_def eq<>(self: String<N: u32>, other: String<N: u32>) -> bool := {
    ...
    ((Array<u8, N: u32> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Array<u8, N: u32>, Array<u8, N: u32>) -> bool)(self_bytes, other_bytes)
  };
}
...
noir_def «std-1.0.0-beta.11»::cmp::Ordering::less<>() -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
  (#_makeData returning «std-1.0.0-beta.11»::cmp::Ordering<>)((0: Field))
}

noir_def «std-1.0.0-beta.11»::cmp::Ordering::equal<>() -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
  (#_makeData returning «std-1.0.0-beta.11»::cmp::Ordering<>)((1: Field))
}

noir_def «std-1.0.0-beta.11»::cmp::Ordering::greater<>() -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
  ...
  noir_def cmp<>(self: Array<T, N: u32>, other: Array<T, N: u32>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    for i in (0: u32) .. (#_arrayLen returning u32)(self) do {
      if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
        result = ((T as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(T, T) -> «std-1.0.0-beta.11»::cmp::Ordering<>)((#_arrayIndex returning T)(self, (#_cast returning u32)(i)), (#_arrayIndex returning T)(other, (#_cast returning u32)(i)));
        #_skip
      }
    };
    result
...
noir_trait_impl[«std-1.0.0-beta.11».impl_111]<T: Type> «std-1.0.0-beta.11»::cmp::Ord<> for Slice<T> where [T: «std-1.0.0-beta.11»::cmp::Ord<>] := {
  noir_def cmp<>(self: Slice<T>, other: Slice<T>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    for i in (0: u32) .. (#_arrayLen returning u32)(self) do {
      if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
        result = ((T as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(T, T) -> «std-1.0.0-beta.11»::cmp::Ordering<>)((#_sliceIndex returning T)(self, (#_cast returning u32)(i)), (#_sliceIndex returning T)(other, (#_cast returning u32)(i)));
        #_skip
      }
    };
    result
...
noir_trait_impl[«std-1.0.0-beta.11».impl_112]<A: Type, B: Type> «std-1.0.0-beta.11»::cmp::Ord<> for Tuple<A, B> where [A: «std-1.0.0-beta.11»::cmp::Ord<>, B: «std-1.0.0-beta.11»::cmp::Ord<>] := {
  noir_def cmp<>(self: Tuple<A, B>, other: Tuple<A, B>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
      ...
      ((B as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(B, B) -> «std-1.0.0-beta.11»::cmp::Ordering<>)(self.1, other.1)
    }
  };
}
...
noir_trait_impl[«std-1.0.0-beta.11».impl_113]<A: Type, B: Type, C: Type> «std-1.0.0-beta.11»::cmp::Ord<> for Tuple<A, B, C> where [A: «std-1.0.0-beta.11»::cmp::Ord<>, B: «std-1.0.0-beta.11»::cmp::Ord<>, C: «std-1.0.0-beta.11»::cmp::Ord<>] := {
  noir_def cmp<>(self: Tuple<A, B, C>, other: Tuple<A, B, C>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
      result = ((B as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(B, B) -> «std-1.0.0-beta.11»::cmp::Ordering<>)(self.1, other.1);
      #_skip
    };
    if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
      result = ((C as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(C, C) -> «std-1.0.0-beta.11»::cmp::Ordering<>)(self.2, other.2);
      #_skip
    };
    result
  };
...
noir_trait_impl[«std-1.0.0-beta.11».impl_114]<A: Type, B: Type, C: Type, D: Type> «std-1.0.0-beta.11»::cmp::Ord<> for Tuple<A, B, C, D> where [A: «std-1.0.0-beta.11»::cmp::Ord<>, B: «std-1.0.0-beta.11»::cmp::Ord<>, C: «std-1.0.0-beta.11»::cmp::Ord<>, D: «std-1.0.0-beta.11»::cmp::Ord<>] := {
  noir_def cmp<>(self: Tuple<A, B, C, D>, other: Tuple<A, B, C, D>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
      result = ((D as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(D, D) -> «std-1.0.0-beta.11»::cmp::Ordering<>)(self.3, other.3);
      #_skip
    };
    result
  };
...
noir_trait_impl[«std-1.0.0-beta.11».impl_115]<A: Type, B: Type, C: Type, D: Type, E: Type> «std-1.0.0-beta.11»::cmp::Ord<> for Tuple<A, B, C, D, E> where [A: «std-1.0.0-beta.11»::cmp::Ord<>, B: «std-1.0.0-beta.11»::cmp::Ord<>, C: «std-1.0.0-beta.11»::cmp::Ord<>, D: «std-1.0.0-beta.11»::cmp::Ord<>, E: «std-1.0.0-beta.11»::cmp::Ord<>] := {
  noir_def cmp<>(self: Tuple<A, B, C, D, E>, other: Tuple<A, B, C, D, E>) -> «std-1.0.0-beta.11»::cmp::Ordering<> := {
    ...
    if ((«std-1.0.0-beta.11»::cmp::Ordering<> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.11»::cmp::Ordering<>, «std-1.0.0-beta.11»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.11»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.11»::cmp::Ordering<>)()) then {
      result = ((E as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(E, E) -> «std-1.0.0-beta.11»::cmp::Ordering<>)(self.4, other.4);
      #_skip
    };
    result
  };
...
noir_def «std-1.0.0-beta.11»::cmp::max<T: Type>(v1: T, v2: T) -> T := {
  if ((T as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(T, T) -> bool)(v1, v2) then {
    v1
  } else {
    v2
  }
...
noir_def «std-1.0.0-beta.11»::cmp::min<T: Type>(v1: T, v2: T) -> T := {
  if ((T as «std-1.0.0-beta.11»::cmp::Ord<>)::cmp<> as λ(T, T) -> bool)(v1, v2) then {
    v2
  } else {
    v1
...
noir_def «std-1.0.0-beta.11»::cmp::cmp_tests::sanity_check_min<>() -> Unit := {
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::min<u64> as λ(u64, u64) -> u64)((0: u64), (1: u64)), (0: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::min<u64> as λ(u64, u64) -> u64)((0: u64), (0: u64)), (0: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::min<u64> as λ(u64, u64) -> u64)((1: u64), (1: u64)), (1: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::min<u8> as λ(u8, u8) -> u8)((255: u8), (0: u8)), (0: u8)));
  #_skip
}

noir_def «std-1.0.0-beta.11»::cmp::cmp_tests::sanity_check_max<>() -> Unit := {
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::max<u64> as λ(u64, u64) -> u64)((0: u64), (1: u64)), (1: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::max<u64> as λ(u64, u64) -> u64)((0: u64), (0: u64)), (0: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::max<u64> as λ(u64, u64) -> u64)((1: u64), (1: u64)), (1: u64)));
  (#_assert returning Unit)((#_uEq returning bool)((«std-1.0.0-beta.11»::cmp::max<u8> as λ(u8, u8) -> u8)((255: u8), (0: u8)), (255: u8)));
  #_skip
}

noir_def «std-1.0.0-beta.11»::cmp::cmp_tests::correctly_handles_unequal_length_slices<>() -> Unit := {
  ...
  (#_assert returning Unit)((#_bNot returning bool)(((Slice<Field> as «std-1.0.0-beta.11»::cmp::Eq<>)::eq<> as λ(Slice<Field>, Slice<Field>) -> bool)(slice_1, slice_2)));
  #_skip
}
