...
noir_def «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint.point_at_infinity<>() -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
  (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)((0: Field), (0: Field), #_true)
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint.generator<>() -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
...
noir_def «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar.new<>(lo: Field, hi: Field) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<> := {
  (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>)(lo, hi)
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar.from_field<>(scalar: Field) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<> := {
  let (a, b) = («std-1.0.0-beta.11».field.bn254.decompose<> as λ(Field) -> Tuple<Field, Field>)(scalar);
  (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>)(a, b)
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar.from_bytes<>(bytes: Array<u8, 64: u32>, offset: u32) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<> := {
  let mut v = (1: Field);
  ...
  let sig_s = (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>)(lo, hi);
  sig_s
}
...
noir_def «std-1.0.0-beta.11».embedded_curve_ops.multi_scalar_mul<N: u32>(points: Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, N: u32>, scalars: Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>, N: u32>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
  (#_arrayIndex returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)((#_multiScalarMul returning Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, 1: u32>)(points, scalars), (0: u32))
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.fixed_base_scalar_mul<>(scalar: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
  («std-1.0.0-beta.11».embedded_curve_ops.multi_scalar_mul<1: u32> as λ(Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, 1: u32>, Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>, 1: u32>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)((#_mkArray returning Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, 1: u32>)((«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint.generator<> as λ() -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)()), (#_mkArray returning Array<«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurveScalar<>, 1: u32>)(scalar))
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add<>(point1: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, point2: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
  if (#_isUnconstrained returning bool)() then {
    if point1.2 then {
      ...
      («std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_unsafe<> as λ(«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point1, point2)
    }
  } else {
    ...
    let point1_1 = (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)((#_fAdd returning Field)(point1.0, (#_cast returning Field)(x_coordinates_match)), point1.1, #_false);
    let point2_1 = (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point2.0, point2.1, #_false);
    let mut result = («std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_unsafe<> as λ(«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point1_1, point2_1);
    let double = («std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_unsafe<> as λ(«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point1, point1);
...
noir_def «std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_not_nul<>(point1: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, point2: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
  ...
  let point1_1 = (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point1.0, point1.1, #_false);
  let point2_1 = (#_makeData returning «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point2.0, point2.1, #_false);
  («std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_unsafe<> as λ(«std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>)(point1_1, point2_1)
}

noir_def «std-1.0.0-beta.11».embedded_curve_ops.embedded_curve_add_unsafe<>(point1: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>, point2: «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<>) -> «std-1.0.0-beta.11».embedded_curve_ops.EmbeddedCurvePoint<> := {
