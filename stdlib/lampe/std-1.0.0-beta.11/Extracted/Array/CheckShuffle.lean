...
noir_def array::check_shuffle::check_shuffle<T: Type, N: u32>(lhs: Array<T, N: u32>, rhs: Array<T, N: u32>) -> Unit := {
  let shuffle_indices = (array::check_shuffle::__get_shuffle_indices<T, N: u32> as λ(Array<T, N: u32>, Array<T, N: u32>) -> Array<u32, N: u32>)(lhs, rhs);
  for i in (0: u32) .. uConst!(N: u32) do {
    let idx = (array::check_shuffle::__get_index<N: u32> as λ(Array<u32, N: u32>, u32) -> u32)(shuffle_indices, i);
  ...
  for i in (0: u32) .. uConst!(N: u32) do {
    ...
    (#_assert returning Unit)(((T as cmp::Eq<>)::eq<> as λ(T, T) -> bool)(expected, result));
    #_skip
  };
  #_skip
}

noir_trait_impl[impl_23]<> cmp::Eq<> for array::check_shuffle::test::CompoundStruct<> where [] := {
  noir_def eq<>(self: array::check_shuffle::test::CompoundStruct<>, other: array::check_shuffle::test::CompoundStruct<>) -> bool := {
...
noir_def array::check_shuffle::test::test_shuffle_compound_struct<>() -> Unit := {
  let lhs = (#_mkArray returning Array<array::check_shuffle::test::CompoundStruct<>, 5: u32>)((#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (0: Field), (12345: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (-100: Field), (54321: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_true, (5: Field), (18446744073709551615: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_true, (9814: Field), (17221745184140693811: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (341: Field), (0: u64)));
  let rhs = (#_mkArray returning Array<array::check_shuffle::test::CompoundStruct<>, 5: u32>)((#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (341: Field), (0: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (0: Field), (12345: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_false, (-100: Field), (54321: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_true, (9814: Field), (17221745184140693811: u64)), (#_makeData returning array::check_shuffle::test::CompoundStruct<>)(#_true, (5: Field), (18446744073709551615: u64)));
  (array::check_shuffle::check_shuffle<array::check_shuffle::test::CompoundStruct<>, 5: u32> as λ(Array<array::check_shuffle::test::CompoundStruct<>, 5: u32>, Array<array::check_shuffle::test::CompoundStruct<>, 5: u32>) -> Unit)(lhs, rhs);
  #_skip
}
