...
noir_def std::collections::bounded_vec::BoundedVec::push<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, elem: T) -> Unit := {
  ...
  {
    let i_3622 = (#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1;
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3622]: T) = elem;
    #_skip
  };
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_array<T: Type, MaxLen: u32, Len: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, array: Array<T, Len: u32>) -> Unit := {
  ...
  for i in (0: u32) .. (#_arrayLen returning u32)(array) do {
    let i_3630 = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3630]: T) = (#_arrayIndex returning T)(array, (#_cast returning u32)(i));
    #_skip
  };
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_slice<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, slice: Slice<T>) -> Unit := {
  ...
  for i in (0: u32) .. (#_arrayLen returning u32)(slice) do {
    let i_3634 = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3634]: T) = (#_sliceIndex returning T)(slice, (#_cast returning u32)(i));
    #_skip
  };
  ((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).1: u32) = new_len;
  #_skip
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec<T: Type, MaxLen: u32, Len: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, vec: std::collections::bounded_vec::BoundedVec<T, Len: u32>) -> Unit := {
  ...
  if (#_isUnconstrained returning bool)() then {
    for i in (0: u32) .. append_len do {
      let i_3640 = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
      (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3640]: T) = (std::collections::bounded_vec::BoundedVec::get_unchecked<T, Len: u32> as λ(std::collections::bounded_vec::BoundedVec<T, Len: u32>, u32) -> T)(vec, i);
      #_skip
    };
    #_skip
  } else {
    ...
    for i in (0: u32) .. uConst!(Len: u32) do {
      ...
      if (#_bNot returning bool)(exceeded_len) then {
        let i_3643 = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
        (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3643]: T) = (std::collections::bounded_vec::BoundedVec::get_unchecked<T, Len: u32> as λ(std::collections::bounded_vec::BoundedVec<T, Len: u32>, u32) -> T)(vec, i);
        #_skip
      }
    };
    #_skip
...
noir_def std::collections::bounded_vec::BoundedVec::pop<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>) -> T := {
  ...
  {
    let i_3649 = (#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1;
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3649]: T) = (#_zeroed returning T)();
    #_skip
  };
  elem
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::get::panics_when_reading_elements_past_end_of_vec<>() -> Unit := {
  ...
  let __0 = (std::collections::bounded_vec::BoundedVec::get<Field, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<Field, 5: u32>, u32) -> Field)(vec, (0: u32));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::get::panics_when_reading_beyond_length<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  let __0 = (std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (3: u32));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::get::get_works_within_bounds<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32> as λ(Array<u32, 5: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 5: u32>)((1: u32), (2: u32), (3: u32), (4: u32), (5: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (2: u32)), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (4: u32)), (5: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::get::get_unchecked_works<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get_unchecked<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get_unchecked<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (2: u32)), (3: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::get::get_unchecked_works_past_len<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get_unchecked<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (4: u32)), (0: u32)));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::set::panics_when_setting_beyond_length<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  (std::collections::bounded_vec::BoundedVec::set<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (3: u32), (4: u32));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::set::set_unchecked_operations<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32));
  (std::collections::bounded_vec::BoundedVec::set_unchecked<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (0: u32), (10: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (10: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::set::set_unchecked_operations_past_len<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32));
  (std::collections::bounded_vec::BoundedVec::set_unchecked<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (3: u32), (40: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (3: u32)), (40: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::set::set_preserves_other_elements<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32> as λ(Array<u32, 5: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 5: u32>)((1: u32), (2: u32), (3: u32), (4: u32), (5: u32)));
  (std::collections::bounded_vec::BoundedVec::set<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32), (30: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (1: u32)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (2: u32)), (30: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (3: u32)), (4: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (4: u32)), (5: u32)));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::any::any_with_complex_predicates<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32> as λ(Array<u32, 5: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 5: u32>)((1: u32), (2: u32), (3: u32), (4: u32), (5: u32)));
  (#_assert returning Unit)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uGt returning bool)(x, (3: u32)))));
  (#_assert returning Unit)((#_bNot returning bool)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uGt returning bool)(x, (10: u32))))));
  (#_assert returning Unit)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uEq returning bool)((#_uRem returning u32)(x, (2: u32)), (0: u32)))));
  (#_assert returning Unit)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uEq returning bool)(x, (3: u32)))));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::any::any_with_partial_vector<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32));
  (#_assert returning Unit)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uEq returning bool)(x, (1: u32)))));
  (#_assert returning Unit)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uEq returning bool)(x, (2: u32)))));
  (#_assert returning Unit)((#_bNot returning bool)((std::collections::bounded_vec::BoundedVec::any<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> bool) -> bool)(vec, (fn(x: u32): bool := (#_uEq returning bool)(x, (3: u32))))));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::map::map_with_conditional_logic<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 4: u32> as λ(Array<u32, 4: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)((#_mkArray returning Array<u32, 4: u32>)((1: u32), (2: u32), (3: u32), (4: u32)));
  let result = (std::collections::bounded_vec::BoundedVec::map<u32, 4: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>, λ(u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)(vec, (fn(x: u32): u32 := if (#_uEq returning bool)((#_uRem returning u32)(x, (2: u32)), (0: u32)) then {
    (#_uMul returning u32)(x, (2: u32))
  } else {
    x
  }));
  let expected = (std::collections::bounded_vec::BoundedVec::from_array<u32, 4: u32> as λ(Array<u32, 4: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)((#_mkArray returning Array<u32, 4: u32>)((1: u32), (4: u32), (3: u32), (8: u32)));
  (#_assert returning Unit)(((std::collections::bounded_vec::BoundedVec<u32, 4: u32> as std::cmp::Eq<>)::eq<> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>, std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> bool)(result, expected));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::map::map_preserves_length<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 4: u32> as λ(Array<u32, 4: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)((#_mkArray returning Array<u32, 4: u32>)((1: u32), (2: u32), (3: u32), (4: u32)));
  let result = (std::collections::bounded_vec::BoundedVec::map<u32, 4: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>, λ(u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)(vec, (fn(x: u32): u32 := (#_uMul returning u32)(x, (2: u32))));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 4: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> u32)(result), (std::collections::bounded_vec::BoundedVec::len<u32, 4: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> u32)(vec)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::max_len<u32, 4: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> u32)(result), (std::collections::bounded_vec::BoundedVec::max_len<u32, 4: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> u32)(vec)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::map::map_on_empty_vector<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let result = (std::collections::bounded_vec::BoundedVec::map<u32, 5: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec, (fn(x: u32): u32 := (#_uMul returning u32)(x, (2: u32))));
  (#_assert returning Unit)(((std::collections::bounded_vec::BoundedVec<u32, 5: u32> as std::cmp::Eq<>)::eq<> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> bool)(result, vec));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(result), (0: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::max_len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(result), (5: u32)));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::mapi::does_not_apply_function_past_len<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32, 2: u32> as λ(Array<u32, 2: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 2: u32>)((0: u32), (1: u32)));
  let result = (std::collections::bounded_vec::BoundedVec::mapi<u32, 3: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, λ(u32, u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec, (fn(__0: u32, value: u32): u32 := if (#_uEq returning bool)(value, (0: u32)) then {
    (5: u32)
  } else {
    value
  }));
...
noir_def std::collections::bounded_vec::bounded_vec_tests::mapi::mapi_with_index_branching_logic<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 4: u32> as λ(Array<u32, 4: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)((#_mkArray returning Array<u32, 4: u32>)((1: u32), (2: u32), (3: u32), (4: u32)));
  let result = (std::collections::bounded_vec::BoundedVec::mapi<u32, 4: u32, Unit> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>, λ(u32, u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)(vec, (fn(i: u32, x: u32): u32 := if (#_uEq returning bool)((#_uRem returning u32)(i, (2: u32)), (0: u32)) then {
    (#_uMul returning u32)(x, (2: u32))
  } else {
    x
  }));
  let expected = (std::collections::bounded_vec::BoundedVec::from_array<u32, 4: u32> as λ(Array<u32, 4: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 4: u32>)((#_mkArray returning Array<u32, 4: u32>)((2: u32), (2: u32), (6: u32), (4: u32)));
  (#_assert returning Unit)(((std::collections::bounded_vec::BoundedVec<u32, 4: u32> as std::cmp::Eq<>)::eq<> as λ(std::collections::bounded_vec::BoundedVec<u32, 4: u32>, std::collections::bounded_vec::BoundedVec<u32, 4: u32>) -> bool)(result, expected));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::for_each::for_each_on_empty_vector<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let mut count = (0: Field);
  let count_ref = (#_ref returning & Field)(count);
  (std::collections::bounded_vec::BoundedVec::for_each<u32, 5: u32, Tuple<& Field> > as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32) -> Unit) -> Unit)(vec, (fn(__0: u32): Unit := {
...
noir_def std::collections::bounded_vec::bounded_vec_tests::for_each::for_each_with_side_effects<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  let mut seen = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  let seen_ref = (#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(seen);
  (std::collections::bounded_vec::BoundedVec::for_each<u32, 3: u32, Tuple<& std::collections::bounded_vec::BoundedVec<u32, 3: u32> > > as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, λ(u32) -> Unit) -> Unit)(vec, (fn(x: u32): Unit := (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)(seen_ref, x)));
  (#_assert returning Unit)(((std::collections::bounded_vec::BoundedVec<u32, 3: u32> as std::cmp::Eq<>)::eq<> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> bool)(seen, vec));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::for_eachi::does_not_apply_function_past_len<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32, 2: u32> as λ(Array<u32, 2: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 2: u32>)((0: u32), (1: u32)));
  let result = (std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_mapi<u32, Unit, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, λ(u32, u32) -> u32) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec, (fn(__0: u32, value: u32): u32 := if (#_uEq returning bool)(value, (0: u32)) then {
    (5: u32)
  } else {
    value
  }));
...
noir_def std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_on_empty_vector<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let mut count = (0: Field);
  let count_ref = (#_ref returning & Field)(count);
  (std::collections::bounded_vec::BoundedVec::for_eachi<u32, 5: u32, Tuple<& Field> > as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, λ(u32, u32) -> Unit) -> Unit)(vec, (fn(__0: u32, __1: u32): Unit := {
    (*count_ref: Field) = (#_fAdd returning Field)((#_readRef returning Field)(count_ref), (1: Field));
    #_skip
  }));
  (#_assert returning Unit)((#_fEq returning bool)(count, (0: Field)));
...
noir_def std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_with_index_tracking<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 3: u32>)((10: u32), (20: u32), (30: u32)));
  let mut indices = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  let indices_ref = (#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(indices);
  (std::collections::bounded_vec::BoundedVec::for_eachi<u32, 3: u32, Tuple<& std::collections::bounded_vec::BoundedVec<u32, 3: u32> > > as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, λ(u32, u32) -> Unit) -> Unit)(vec, (fn(i: u32, __0: u32): Unit := (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)(indices_ref, i)));
  let expected = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 3: u32>)((0: u32), (1: u32), (2: u32)));
  (#_assert returning Unit)(((std::collections::bounded_vec::BoundedVec<u32, 3: u32> as std::cmp::Eq<>)::eq<> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> bool)(indices, expected));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::from_array::max_len_lower_then_array_len<>() -> Unit := {
  let __0 = (std::collections::bounded_vec::BoundedVec::from_array<Field, 2: u32, 3: u32> as λ(Array<Field, 3: u32>) -> std::collections::bounded_vec::BoundedVec<Field, 2: u32>)((#_mkRepeatedArray returning Array<Field, 3: u32>)((0: Field)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::from_array::from_array_preserves_order<>() -> Unit := {
  let array = (#_mkArray returning Array<u32, 5: u32>)((5: u32), (3: u32), (1: u32), (4: u32), (2: u32));
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32> as λ(Array<u32, 5: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(array);
  for i in (0: u32) .. (#_arrayLen returning u32)(array) do {
    (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, i), (#_arrayIndex returning u32)(array, (#_cast returning u32)(i))));
    #_skip
  };
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::from_array::from_array_with_different_types<>() -> Unit := {
  let bool_array = (#_mkArray returning Array<bool, 3: u32>)(#_true, #_false, #_true);
  let bool_vec = (std::collections::bounded_vec::BoundedVec::from_array<bool, 3: u32> as λ(Array<bool, 3: u32>) -> std::collections::bounded_vec::BoundedVec<bool, 3: u32>)(bool_array);
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<bool, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<bool, 3: u32>) -> u32)(bool_vec), (3: u32)));
  (#_assert returning Unit)((#_bEq returning bool)((std::collections::bounded_vec::BoundedVec::get<bool, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<bool, 3: u32>, u32) -> bool)(bool_vec, (0: u32)), #_true));
  (#_assert returning Unit)((#_bEq returning bool)((std::collections::bounded_vec::BoundedVec::get<bool, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<bool, 3: u32>, u32) -> bool)(bool_vec, (1: u32)), #_false));
  #_skip
}
...
noir_def std::collections::bounded_vec::bounded_vec_tests::push_pop::push_and_pop_operations<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (0: u32)));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (1: u32)), (2: u32)));
  let popped = (std::collections::bounded_vec::BoundedVec::pop<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec));
  (#_assert returning Unit)((#_uEq returning bool)(popped, (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (1: u32)));
  let popped2 = (std::collections::bounded_vec::BoundedVec::pop<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec));
  (#_assert returning Unit)((#_uEq returning bool)(popped2, (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (0: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::push_pop::push_to_full_vector<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 2: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 2: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 2: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 2: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 2: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 2: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 2: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 2: u32>)(vec), (2: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 2: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 2: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 2: u32>)(vec), (3: u32));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::push_pop::pop_from_empty_vector<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let __0 = (std::collections::bounded_vec::BoundedVec::pop<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::push_pop::push_pop_cycle<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (2: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (3: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)(vec), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::pop<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec)), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::pop<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::pop<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)(vec), (0: u32)));
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (4: u32));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)(vec), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> u32)(vec, (0: u32)), (4: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_array<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::extend_from_array<u32, 5: u32, 2: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, Array<u32, 2: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (#_mkArray returning Array<u32, 2: u32>)((2: u32), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (1: u32)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (2: u32)), (3: u32)));
  #_skip
...
noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_slice<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::extend_from_slice<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, Slice<u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (#_mkSlice returning Slice<u32>)((2: u32), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (1: u32)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec, (2: u32)), (3: u32)));
...
noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_bounded_vec<>() -> Unit := {
  let mut vec1 = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let mut vec2 = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec1), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec2), (2: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec2), (3: u32));
  (std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec<u32, 5: u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec1), vec2);
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec1), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec1, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec1, (1: u32)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> u32)(vec1, (2: u32)), (3: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_array_beyond_max_len<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::extend_from_array<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, Array<u32, 3: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (#_mkArray returning Array<u32, 3: u32>)((2: u32), (3: u32), (4: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_slice_beyond_max_len<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  (std::collections::bounded_vec::BoundedVec::push<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::extend_from_slice<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, Slice<u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), (#_mkSlice returning Slice<u32>)((2: u32), (3: u32), (4: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_bounded_vec_beyond_max_len<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  let other = (std::collections::bounded_vec::BoundedVec::from_array<u32, 5: u32> as λ(Array<u32, 5: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)((#_mkArray returning Array<u32, 5: u32>)((1: u32), (2: u32), (3: u32), (4: u32), (5: u32)));
  (std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec<u32, 3: u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>, std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec), other);
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::extend::extend_with_empty_collections<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  let original_len = (std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec);
  (std::collections::bounded_vec::BoundedVec::extend_from_array<u32, 5: u32, 0: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, Array<u32, 0: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (#_mkArray returning Array<u32, 0: u32>)());
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), original_len));
  (std::collections::bounded_vec::BoundedVec::extend_from_slice<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, Slice<u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (#_mkSlice returning Slice<u32>)());
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), original_len));
  let empty = (std::collections::bounded_vec::BoundedVec::new<u32, 3: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)();
  (std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec<u32, 5: u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), empty);
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), original_len));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::storage::storage_consistency<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::new<u32, 5: u32> as λ() -> std::collections::bounded_vec::BoundedVec<u32, 5: u32>)();
  (#_assert returning Unit)(((Array<u32, 5: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 5: u32>, Array<u32, 5: u32>) -> bool)((std::collections::bounded_vec::BoundedVec::storage<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> Array<u32, 5: u32>)(vec), (#_mkArray returning Array<u32, 5: u32>)((0: u32), (0: u32), (0: u32), (0: u32), (0: u32))));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (1: u32));
  (std::collections::bounded_vec::BoundedVec::push<u32, 5: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 5: u32>, u32) -> Unit)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 5: u32>)(vec), (2: u32));
  (#_assert returning Unit)(((Array<u32, 5: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 5: u32>, Array<u32, 5: u32>) -> bool)((std::collections::bounded_vec::BoundedVec::storage<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> Array<u32, 5: u32>)(vec), (#_mkArray returning Array<u32, 5: u32>)((1: u32), (2: u32), (0: u32), (0: u32), (0: u32))));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::max_len<u32, 5: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 5: u32>) -> u32)(vec), (5: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::storage::storage_after_pop<>() -> Unit := {
  let mut vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  let __0 = (std::collections::bounded_vec::BoundedVec::pop<u32, 3: u32> as λ(& std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)((#_ref returning & std::collections::bounded_vec::BoundedVec<u32, 3: u32>)(vec));
  (#_assert returning Unit)(((Array<u32, 3: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 3: u32>, Array<u32, 3: u32>) -> bool)((std::collections::bounded_vec::BoundedVec::storage<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> Array<u32, 3: u32>)(vec), (#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (0: u32))));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)(vec), (2: u32)));
  #_skip
}

noir_def std::collections::bounded_vec::bounded_vec_tests::storage::vector_immutable<>() -> Unit := {
  let vec = (std::collections::bounded_vec::BoundedVec::from_array<u32, 3: u32> as λ(Array<u32, 3: u32>) -> std::collections::bounded_vec::BoundedVec<u32, 3: u32>)((#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32)));
  let storage = (std::collections::bounded_vec::BoundedVec::storage<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> Array<u32, 3: u32>)(vec);
  (#_assert returning Unit)(((Array<u32, 3: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 3: u32>, Array<u32, 3: u32>) -> bool)(storage, (#_mkArray returning Array<u32, 3: u32>)((1: u32), (2: u32), (3: u32))));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::len<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>) -> u32)(vec), (3: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> u32)(vec, (0: u32)), (1: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> u32)(vec, (1: u32)), (2: u32)));
  (#_assert returning Unit)((#_uEq returning bool)((std::collections::bounded_vec::BoundedVec::get<u32, 3: u32> as λ(std::collections::bounded_vec::BoundedVec<u32, 3: u32>, u32) -> u32)(vec, (2: u32)), (3: u32)));
  #_skip
}

def Collections.BoundedVec.env : Env := Env.mk
  [«std::collections::bounded_vec::BoundedVec::new», «std::collections::bounded_vec::BoundedVec::get», «std::collections::bounded_vec::BoundedVec::get_unchecked», «std::collections::bounded_vec::BoundedVec::set», «std::collections::bounded_vec::BoundedVec::set_unchecked», «std::collections::bounded_vec::BoundedVec::push», «std::collections::bounded_vec::BoundedVec::len», «std::collections::bounded_vec::BoundedVec::max_len», «std::collections::bounded_vec::BoundedVec::storage», «std::collections::bounded_vec::BoundedVec::extend_from_array», «std::collections::bounded_vec::BoundedVec::extend_from_slice», «std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec», «std::collections::bounded_vec::BoundedVec::from_array», «std::collections::bounded_vec::BoundedVec::pop», «std::collections::bounded_vec::BoundedVec::any», «std::collections::bounded_vec::BoundedVec::map», «std::collections::bounded_vec::BoundedVec::mapi», «std::collections::bounded_vec::BoundedVec::for_each», «std::collections::bounded_vec::BoundedVec::for_eachi», «std::collections::bounded_vec::BoundedVec::from_parts», «std::collections::bounded_vec::BoundedVec::from_parts_unchecked», «std::collections::bounded_vec::bounded_vec_tests::get::panics_when_reading_elements_past_end_of_vec», «std::collections::bounded_vec::bounded_vec_tests::get::panics_when_reading_beyond_length», «std::collections::bounded_vec::bounded_vec_tests::get::get_works_within_bounds», «std::collections::bounded_vec::bounded_vec_tests::get::get_unchecked_works», «std::collections::bounded_vec::bounded_vec_tests::get::get_unchecked_works_past_len», «std::collections::bounded_vec::bounded_vec_tests::set::set_updates_values_properly», «std::collections::bounded_vec::bounded_vec_tests::set::panics_when_writing_elements_past_end_of_vec», «std::collections::bounded_vec::bounded_vec_tests::set::panics_when_setting_beyond_length», «std::collections::bounded_vec::bounded_vec_tests::set::set_unchecked_operations», «std::collections::bounded_vec::bounded_vec_tests::set::set_unchecked_operations_past_len», «std::collections::bounded_vec::bounded_vec_tests::set::set_preserves_other_elements», «std::collections::bounded_vec::bounded_vec_tests::any::returns_false_if_predicate_not_satisfied», «std::collections::bounded_vec::bounded_vec_tests::any::returns_true_if_predicate_satisfied», «std::collections::bounded_vec::bounded_vec_tests::any::returns_false_on_empty_boundedvec», «std::collections::bounded_vec::bounded_vec_tests::any::any_with_complex_predicates», «std::collections::bounded_vec::bounded_vec_tests::any::any_with_partial_vector», «std::collections::bounded_vec::bounded_vec_tests::map::applies_function_correctly», «std::collections::bounded_vec::bounded_vec_tests::map::applies_function_that_changes_return_type», «std::collections::bounded_vec::bounded_vec_tests::map::does_not_apply_function_past_len», «std::collections::bounded_vec::bounded_vec_tests::map::map_with_conditional_logic», «std::collections::bounded_vec::bounded_vec_tests::map::map_preserves_length», «std::collections::bounded_vec::bounded_vec_tests::map::map_on_empty_vector», «std::collections::bounded_vec::bounded_vec_tests::mapi::applies_function_correctly», «std::collections::bounded_vec::bounded_vec_tests::mapi::applies_function_that_changes_return_type», «std::collections::bounded_vec::bounded_vec_tests::mapi::does_not_apply_function_past_len», «std::collections::bounded_vec::bounded_vec_tests::mapi::mapi_with_index_branching_logic», «std::collections::bounded_vec::bounded_vec_tests::for_each::for_each_map», «std::collections::bounded_vec::bounded_vec_tests::for_each::smoke_test», «std::collections::bounded_vec::bounded_vec_tests::for_each::applies_function_correctly», «std::collections::bounded_vec::bounded_vec_tests::for_each::applies_function_that_changes_return_type», «std::collections::bounded_vec::bounded_vec_tests::for_each::does_not_apply_function_past_len», «std::collections::bounded_vec::bounded_vec_tests::for_each::for_each_on_empty_vector», «std::collections::bounded_vec::bounded_vec_tests::for_each::for_each_with_side_effects», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_mapi», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::smoke_test», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::applies_function_correctly», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::applies_function_that_changes_return_type», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::does_not_apply_function_past_len», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_on_empty_vector», «std::collections::bounded_vec::bounded_vec_tests::for_eachi::for_eachi_with_index_tracking», «std::collections::bounded_vec::bounded_vec_tests::from_array::empty», «std::collections::bounded_vec::bounded_vec_tests::from_array::equal_len», «std::collections::bounded_vec::bounded_vec_tests::from_array::max_len_greater_then_array_len», «std::collections::bounded_vec::bounded_vec_tests::from_array::max_len_lower_then_array_len», «std::collections::bounded_vec::bounded_vec_tests::from_array::from_array_preserves_order», «std::collections::bounded_vec::bounded_vec_tests::from_array::from_array_with_different_types», «std::collections::bounded_vec::bounded_vec_tests::trait_from::simple», «std::collections::bounded_vec::bounded_vec_tests::trait_eq::empty_equality», «std::collections::bounded_vec::bounded_vec_tests::trait_eq::inequality», «std::collections::bounded_vec::bounded_vec_tests::from_parts::from_parts», «std::collections::bounded_vec::bounded_vec_tests::from_parts::from_parts_unchecked», «std::collections::bounded_vec::bounded_vec_tests::push_pop::push_and_pop_operations», «std::collections::bounded_vec::bounded_vec_tests::push_pop::push_to_full_vector», «std::collections::bounded_vec::bounded_vec_tests::push_pop::pop_from_empty_vector», «std::collections::bounded_vec::bounded_vec_tests::push_pop::push_pop_cycle», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_array», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_slice», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_from_bounded_vec», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_array_beyond_max_len», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_slice_beyond_max_len», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_bounded_vec_beyond_max_len», «std::collections::bounded_vec::bounded_vec_tests::extend::extend_with_empty_collections», «std::collections::bounded_vec::bounded_vec_tests::storage::storage_consistency», «std::collections::bounded_vec::bounded_vec_tests::storage::storage_after_pop», «std::collections::bounded_vec::bounded_vec_tests::storage::vector_immutable»]
  [impl_32, impl_33]
