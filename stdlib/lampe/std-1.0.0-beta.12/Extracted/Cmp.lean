...
noir_def «std-1.0.0-beta.12»::cmp::max<T: Type>(v1: T, v2: T) -> T := {
  if (#_bEq returning bool)(((T as «std-1.0.0-beta.12»::cmp::Ord<>)::cmp<> as λ(T, T) -> bool)(v1, v2), («std-1.0.0-beta.12»::cmp::Ordering::greater<> as λ() -> «std-1.0.0-beta.12»::cmp::Ordering<>)()) then {
    v1
  } else {
    v2
  }
