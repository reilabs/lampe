...
noir_trait_impl[«std-1.0.0-beta.12».impl_111]<T: Type> «std-1.0.0-beta.12»::cmp::Ord<> for Slice<T> where [T: «std-1.0.0-beta.12»::cmp::Ord<>] := {
  noir_def cmp<>(self: Slice<T>, other: Slice<T>) -> «std-1.0.0-beta.12»::cmp::Ordering<> := {
    ...
    if (#_bNot returning bool)(((«std-1.0.0-beta.12»::cmp::Ordering<> as «std-1.0.0-beta.12»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.12»::cmp::Ordering<>, «std-1.0.0-beta.12»::cmp::Ordering<>) -> bool)(result, («std-1.0.0-beta.12»::cmp::Ordering::equal<> as λ() -> «std-1.0.0-beta.12»::cmp::Ordering<>)())) then {
      result
    } else {
...
noir_def «std-1.0.0-beta.12»::cmp::max<T: Type>(v1: T, v2: T) -> T := {
  if {
    let __0 = ((T as «std-1.0.0-beta.12»::cmp::Ord<>)::cmp<> as λ(T, T) -> «std-1.0.0-beta.12»::cmp::Ordering<>)(v1, v2);
    let __1 = («std-1.0.0-beta.12»::cmp::Ordering::greater<> as λ() -> «std-1.0.0-beta.12»::cmp::Ordering<>)();
    ((«std-1.0.0-beta.12»::cmp::Ordering<> as «std-1.0.0-beta.12»::cmp::Eq<>)::eq<> as λ(«std-1.0.0-beta.12»::cmp::Ordering<>, «std-1.0.0-beta.12»::cmp::Ordering<>) -> bool)(__0, __1)
  } then {
    v1
  } else {
    v2
...
def «std-1.0.0-beta.12».Cmp.env : Env := Env.mk
  ...
  [«std-1.0.0-beta.12».impl_78, «std-1.0.0-beta.12».impl_79, «std-1.0.0-beta.12».impl_80, «std-1.0.0-beta.12».impl_81, «std-1.0.0-beta.12».impl_82, «std-1.0.0-beta.12».impl_83, «std-1.0.0-beta.12».impl_84, «std-1.0.0-beta.12».impl_85, «std-1.0.0-beta.12».impl_86, «std-1.0.0-beta.12».impl_87, «std-1.0.0-beta.12».impl_88, «std-1.0.0-beta.12».impl_89, «std-1.0.0-beta.12».impl_90, «std-1.0.0-beta.12».impl_91, «std-1.0.0-beta.12».impl_92, «std-1.0.0-beta.12».impl_93, «std-1.0.0-beta.12».impl_94, «std-1.0.0-beta.12».impl_95, «std-1.0.0-beta.12».impl_96, «std-1.0.0-beta.12».impl_97, «std-1.0.0-beta.12».impl_98, «std-1.0.0-beta.12».impl_99, «std-1.0.0-beta.12».impl_100, «std-1.0.0-beta.12».impl_101, «std-1.0.0-beta.12».impl_102, «std-1.0.0-beta.12».impl_103, «std-1.0.0-beta.12».impl_104, «std-1.0.0-beta.12».impl_105, «std-1.0.0-beta.12».impl_106, «std-1.0.0-beta.12».impl_107, «std-1.0.0-beta.12».impl_108, «std-1.0.0-beta.12».impl_109, «std-1.0.0-beta.12».impl_110, «std-1.0.0-beta.12».impl_111, «std-1.0.0-beta.12».impl_112, «std-1.0.0-beta.12».impl_113, «std-1.0.0-beta.12».impl_114, «std-1.0.0-beta.12».impl_115]
