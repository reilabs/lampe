...
noir_def std::collections::umap::UHashMap::with_hasher_and_capacity<K: Type, V: Type, B: Type, B_as_BuildHasher_H: Type>(_build_hasher: B, capacity: u32) -> std::collections::umap::UHashMap<K, V, B> := {
  ...
  for _ in (0: u32) .. capacity do {
    _table = (std::slice::push_back<> as λ(Slice<std::collections::umap::Slot<K, V> >, std::collections::umap::Slot<K, V>) -> Slice<std::collections::umap::Slot<K, V> >)(_table, ((std::collections::umap::Slot<K, V> as std::default::Default<>)::default<> as λ() -> std::collections::umap::Slot<K, V>)());
    #_skip
  };
  let (_len: u32) = (0: u32);
  (#_makeData returning std::collections::umap::UHashMap<K, V, B>)(_table, _len, _build_hasher)
...
noir_def std::collections::umap::UHashMap::entries<K: Type, V: Type, B: Type>(self: std::collections::umap::UHashMap<K, V, B>) -> Slice<Tuple<K, V> > := {
  let mut (entries: Slice<Tuple<K, V> >) = (#_mkSlice returning Slice<Tuple<K, V> >)();
  {
    ...
    for ζi1 in (0: u32) .. (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)(ζi0) do {
      let (slot: std::collections::umap::Slot<K, V>) = (#_sliceIndex returning std::collections::umap::Slot<K, V>)(ζi0, (#_cast returning u32)(ζi1));
      {
        if (std::collections::umap::Slot::is_valid<> as λ(std::collections::umap::Slot<K, V>) -> bool)(slot) then {
          ...
          entries = (std::slice::push_back<> as λ(Slice<Tuple<K, V> >, Tuple<K, V>) -> Slice<Tuple<K, V> >)(entries, key_value);
          #_skip
        }
      }
    };
  ...
  let (entries_len: u32) = (std::slice::len<> as λ(Slice<Tuple<K, V> >) -> u32)(entries);
  ...
  (#_assert returning Unit)((#_uEq returning bool)((std::slice::len<> as λ(Slice<Tuple<K, V> >) -> u32)(entries), self.1));
  entries
}
...
noir_def std::collections::umap::UHashMap::keys<K: Type, V: Type, B: Type>(self: std::collections::umap::UHashMap<K, V, B>) -> Slice<K> := {
    ...
    for ζi1 in (0: u32) .. (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)(ζi0) do {
      let (slot: std::collections::umap::Slot<K, V>) = (#_sliceIndex returning std::collections::umap::Slot<K, V>)(ζi0, (#_cast returning u32)(ζi1));
      {
        if (std::collections::umap::Slot::is_valid<> as λ(std::collections::umap::Slot<K, V>) -> bool)(slot) then {
          ...
          keys = (std::slice::push_back<> as λ(Slice<K>, K) -> Slice<K>)(keys, key);
          #_skip
        }
      }
    };
  ...
  let (self_len: u32) = self.1;
  let (keys_len: u32) = (std::slice::len<> as λ(Slice<K>) -> u32)(keys);
  ...
  (#_assert returning Unit)((#_uEq returning bool)((std::slice::len<> as λ(Slice<K>) -> u32)(keys), self.1));
  keys
}
...
noir_def std::collections::umap::UHashMap::values<K: Type, V: Type, B: Type>(self: std::collections::umap::UHashMap<K, V, B>) -> Slice<V> := {
    ...
    for ζi1 in (0: u32) .. (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)(ζi0) do {
      let (slot: std::collections::umap::Slot<K, V>) = (#_sliceIndex returning std::collections::umap::Slot<K, V>)(ζi0, (#_cast returning u32)(ζi1));
      {
        if (std::collections::umap::Slot::is_valid<> as λ(std::collections::umap::Slot<K, V>) -> bool)(slot) then {
          ...
          values = (std::slice::push_back<> as λ(Slice<V>, V) -> Slice<V>)(values, value);
          #_skip
        }
      }
    };
  ...
  let (self_len: u32) = self.1;
  let (values_len: u32) = (std::slice::len<> as λ(Slice<V>) -> u32)(values);
  ...
  (#_assert returning Unit)((#_uEq returning bool)((std::slice::len<> as λ(Slice<V>) -> u32)(values), self.1));
  values
}
...
noir_def std::collections::umap::UHashMap::iter_values_mut<K: Type, V: Type, B: Type>(self: & std::collections::umap::UHashMap<K, V, B>, f: λ(V) -> V) -> Unit := {
  for i in (0: u32) .. (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)((#_readRef returning std::collections::umap::UHashMap<K, V, B>)(self).0) do {
...
noir_def std::collections::umap::UHashMap::retain<K: Type, V: Type, B: Type>(self: & std::collections::umap::UHashMap<K, V, B>, f: λ(K, V) -> bool) -> Unit := {
  for index in (0: u32) .. (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)((#_readRef returning std::collections::umap::UHashMap<K, V, B>)(self).0) do {
...
noir_def std::collections::umap::UHashMap::capacity<K: Type, V: Type, B: Type>(self: std::collections::umap::UHashMap<K, V, B>) -> u32 := {
  (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)(self.0)
}
...
noir_def std::collections::umap::UHashMap::quadratic_probe<K: Type, V: Type, B: Type>(self: std::collections::umap::UHashMap<K, V, B>, hash: u32, attempt: u32) -> u32 := {
  (#_uRem returning u32)((#_uAdd returning u32)(hash, (#_uDiv returning u32)((#_uAdd returning u32)(attempt, (#_uMul returning u32)(attempt, attempt)), (2: u32))), (std::slice::len<> as λ(Slice<std::collections::umap::Slot<K, V> >) -> u32)(self.0))
}
