...
nr_def «collections»::«umap»::«UHashMap»::«with_hasher»<K, V, B, B_as_BuildHasher_H>(_build_hasher : B) -> collections::umap::UHashMap< K, V, B > {
    let _table = #mkSlice(((collections::umap::Slot< K, V > as std::default::Default<  >)::default< K, V > as λ() → collections::umap::Slot< K, V >)()) : [collections::umap::Slot< K, V >];
    let _len = 0 : u32;
    collections::umap::UHashMap< K,V,B > { _table, _len, _build_hasher };
}

nr_def «collections»::«umap»::«UHashMap»::«with_hasher_and_capacity»<K, V, B, B_as_BuildHasher_H>(_build_hasher : B, capacity : u32) -> collections::umap::UHashMap< K, V, B > {
    let mut _table = #mkSlice() : [collections::umap::Slot< K, V >];
    for _? in 0 : u32 .. capacity {
            _table = (@std::slice::push_back< collections::umap::Slot< K, V > > as λ([collections::umap::Slot< K, V >], collections::umap::Slot< K, V >) → [collections::umap::Slot< K, V >])(_table, ((collections::umap::Slot< K, V > as std::default::Default<  >)::default< K, V > as λ() → collections::umap::Slot< K, V >)());
        skip;
    };
    let _len = 0 : u32;
    collections::umap::UHashMap< K,V,B > { _table, _len, _build_hasher };
...
nr_def «collections»::«umap»::«UHashMap»::«clear»<K, V, B>(self : & collections::umap::UHashMap< K, V, B >) -> Unit {
    (*(self) as collections::umap::UHashMap< K, V, B >)._table = #mkSlice(((collections::umap::Slot< K, V > as std::default::Default<  >)::default< K, V > as λ() → collections::umap::Slot< K, V >)()) : [collections::umap::Slot< K, V >];
...
nr_def «collections»::«umap»::«UHashMap»::«iter_mut»<K, V, B, B_as_BuildHasher_H>(self : & collections::umap::UHashMap< K, V, B >, f : λ(K, V) → `(K, V)) -> Unit {
    #fresh() : Unit
}

nr_def «collections»::«umap»::«UHashMap»::«iter_keys_mut»<K, V, B, B_as_BuildHasher_H>(self : & collections::umap::UHashMap< K, V, B >, f : λ(K) → K) -> Unit {
    #fresh() : Unit
}
...
nr_def «collections»::«umap»::«UHashMap»::«get»<K, V, B, B_as_BuildHasher_H>(self : collections::umap::UHashMap< K, V, B >, key : K) -> option::Option< V > {
    #fresh() : option::Option< V >
}

nr_def «collections»::«umap»::«UHashMap»::«insert»<K, V, B, B_as_BuildHasher_H>(self : & collections::umap::UHashMap< K, V, B >, key : K, value : V) -> Unit {
    #fresh() : Unit
}

nr_def «collections»::«umap»::«UHashMap»::«try_resize»<K, V, B, B_as_BuildHasher_H>(self : & collections::umap::UHashMap< K, V, B >) -> Unit {
    #fresh() : Unit
}

nr_def «collections»::«umap»::«UHashMap»::«remove»<K, V, B, B_as_BuildHasher_H>(self : & collections::umap::UHashMap< K, V, B >, key : K) -> Unit {
    #fresh() : Unit
}

nr_def «collections»::«umap»::«UHashMap»::«hash»<K, V, B, B_as_BuildHasher_H>(self : collections::umap::UHashMap< K, V, B >, key : K) -> u32 {
    let mut hasher = ((B as std::hash::BuildHasher<  >)::build_hasher< B_as_BuildHasher_H, B > as λ(B) → B_as_BuildHasher_H)((self as collections::umap::UHashMap< K, V, B >)._build_hasher);
...
nr_trait_impl[impl_38] <K, V, B, B_as_BuildHasher_H> std::cmp::Eq<  > for collections::umap::UHashMap< K, V, B > where K : Eq<>, K : Hash<>, V : Eq<>, B : BuildHasher<B_as_BuildHasher_H> {
...
nr_trait_impl[impl_39] <K, V, B, B_as_BuildHasher_H> std::default::Default<  > for collections::umap::UHashMap< K, V, B > where B : BuildHasher<B_as_BuildHasher_H>, B : Default<> {
    fn «default»<> () -> collections::umap::UHashMap< K, V, B > {
        (@collections::umap::UHashMap::with_hasher< K, V, B, B_as_BuildHasher_H > as λ(B) → collections::umap::UHashMap< K, V, B >)(((B as std::default::Default<  >)::default< B > as λ() → B)());
}
}
