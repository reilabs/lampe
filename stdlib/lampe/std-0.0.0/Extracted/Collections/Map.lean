...
noir_def std::collections::map::HashMap::entries<K: Type, V: Type, N: u32, B: Type>(self: std::collections::map::HashMap<K, V, N: u32, B>) -> std::collections::bounded_vec::BoundedVec<Tuple<K, V>, N: u32> := {
  let mut (entries: std::collections::bounded_vec::BoundedVec<Tuple<K, V>, N: u32>) = (std::collections::bounded_vec::BoundedVec::new<> as λ() -> std::collections::bounded_vec::BoundedVec<Tuple<K, V>, N: u32>)();
  {
    ...
    for ζi1 in (0: u32) .. (std::array::len<> as λ(Array<std::collections::map::Slot<K, V>, N: u32>) -> u32)(ζi0) do {
...
noir_def std::collections::map::HashMap::assert_load_factor<K: Type, V: Type, N: u32, B: Type>(self: std::collections::map::HashMap<K, V, N: u32, B>) -> Unit := {
  ...
  let (rhs: u32) = (#_uMul returning u32)((std::array::len<> as λ(Array<std::collections::map::Slot<K, V>, N: u32>) -> u32)(self.0), (MAX_LOAD_FACTOR_NUMERATOR<> as λ() -> u32)());
