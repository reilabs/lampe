...
noir_def std::collections::bounded_vec::BoundedVec::push<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, elem: T) -> Unit := {
  ...
  {
    let (i_3527: Unit) = (#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1;
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3527]: T) = elem;
    #_skip
  };
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_array<T: Type, MaxLen: u32, Len: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, array: Array<T, Len: u32>) -> Unit := {
  let (new_len: u32) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, (std::array::len<> as λ(Array<T, Len: u32>) -> u32)(array));
  (#_assert returning Unit)((#_uLeq returning bool)(new_len, uConst!(MaxLen: u32)));
  for i in (0: u32) .. (std::array::len<> as λ(Array<T, Len: u32>) -> u32)(array) do {
    let (i_3535: Unit) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3535]: T) = (#_arrayIndex returning T)(array, (#_cast returning u32)(i));
    #_skip
  };
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_slice<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, slice: Slice<T>) -> Unit := {
  let (new_len: u32) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, (std::slice::len<> as λ(Slice<T>) -> u32)(slice));
  (#_assert returning Unit)((#_uLeq returning bool)(new_len, uConst!(MaxLen: u32)));
  for i in (0: u32) .. (std::slice::len<> as λ(Slice<T>) -> u32)(slice) do {
    let (i_3539: Unit) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3539]: T) = (#_sliceIndex returning T)(slice, (#_cast returning u32)(i));
    #_skip
  };
  ((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).1: u32) = new_len;
  #_skip
...
noir_def std::collections::bounded_vec::BoundedVec::extend_from_bounded_vec<T: Type, MaxLen: u32, Len: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>, vec: std::collections::bounded_vec::BoundedVec<T, Len: u32>) -> Unit := {
  ...
  if (runtime::is_unconstrained<> as λ() -> bool)() then {
    for i in (0: u32) .. append_len do {
      let (i_3545: Unit) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
      (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3545]: T) = (std::collections::bounded_vec::BoundedVec::get_unchecked<> as λ(std::collections::bounded_vec::BoundedVec<T, Len: u32>, u32) -> T)(vec, i);
      #_skip
    };
    #_skip
  } else {
    ...
    for i in (0: u32) .. uConst!(Len: u32) do {
      ...
      if (#_bNot returning bool)(exceeded_len) then {
        let (i_3548: Unit) = (#_uAdd returning u32)((#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1, i);
        (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3548]: T) = (std::collections::bounded_vec::BoundedVec::get_unchecked<> as λ(std::collections::bounded_vec::BoundedVec<T, Len: u32>, u32) -> T)(vec, i);
        #_skip
      }
    };
    #_skip
...
noir_def std::collections::bounded_vec::BoundedVec::pop<T: Type, MaxLen: u32>(self: & std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>) -> T := {
  ...
  {
    let (i_3554: Unit) = (#_readRef returning std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>)(self).1;
    (((*self: std::collections::bounded_vec::BoundedVec<T, MaxLen: u32>).0: Array<T, MaxLen: u32>)[i_3554]: T) = (#_zeroed returning T)();
    #_skip
  };
  elem
}
...
noir_def collections::bounded_vec::bounded_vec_tests::get::panics_when_reading_elements_past_end_of_vec<>() -> Unit := {
  ...
  (println<Field> as λ(Field) -> Unit)((std::collections::bounded_vec::BoundedVec::get<> as λ(std::collections::bounded_vec::BoundedVec<Field, 5: u32>, u32) -> Field)(vec, (0: u32)));
  #_skip
}
