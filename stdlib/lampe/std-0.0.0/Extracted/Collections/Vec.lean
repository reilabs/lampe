...
noir_def std::collections::vec::Vec::push<T: Type>(self: & std::collections::vec::Vec<T>, elem: T) -> Unit := {
  ((*self: std::collections::vec::Vec<T>).0: Slice<T>) = (std::slice::push_back<> as λ(Slice<T>, T) -> Slice<T>)((#_readRef returning std::collections::vec::Vec<T>)(self).0, elem);
  #_skip
}

noir_def std::collections::vec::Vec::pop<T: Type>(self: & std::collections::vec::Vec<T>) -> T := {
  let ((popped_slice: Slice<T>), (last_elem: T)) = (std::slice::pop_back<> as λ(Slice<T>) -> Tuple<Slice<T>, T>)((#_readRef returning std::collections::vec::Vec<T>)(self).0);
...
noir_def std::collections::vec::Vec::len<T: Type>(self: std::collections::vec::Vec<T>) -> u32 := {
  (std::slice::len<> as λ(Slice<T>) -> u32)(self.0)
}
...
noir_def collections::vec::tests::panics_when_writing_elements_past_end_of_vec<>() -> Unit := {
  ...
  (std::collections::vec::Vec::set<> as λ(& std::collections::vec::Vec<Field>, u32, Field) -> Unit)((#_ref returning & std::collections::vec::Vec<Field>)(vec), (0: u32), (42: Field));
  (println<Field> as λ(Field) -> Unit)((std::collections::vec::Vec::get<> as λ(std::collections::vec::Vec<Field>, u32) -> Field)(vec, (0: u32)));
  #_skip
}
