...
nr_def «hash»::«assert_pedersen»<>() -> Unit {
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 3 : u32 > as λ([Field; 3], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field], 3 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { -7445492827528947374509602945629683494533192071041804482180938699494227714940 : Field, -346969586742294743999106690738565516862306986837138292504091779330690805808 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 4 : u32 > as λ([Field; 4], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field], 4 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 3474050104565946163748262682994355436071725368663608454945085151569694677961 : Field, 4969143737471383592015577254419974288705429190161323890019554309538525237268 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 5 : u32 > as λ([Field; 5], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field], 5 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 10552833461612204383225982278685649771700648236894998952452362214619168226089 : Field, -1251131729610909206337824637802607977413231765663205492654376476649374713610 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 6 : u32 > as λ([Field; 6], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field, 6 : Field], 6 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 11335069702571578236117888955050736139682779524214984889155721704928197387927 : Field, -7733361908666485801415200275635877656445756448956549185022038133647049615622 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 7 : u32 > as λ([Field; 7], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field, 6 : Field, 7 : Field], 7 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 601182919381464537093882307577577658521785998356796832152269409048770009401 : Field, -8704984668101593449807889537070046830501821124601109099832679891796819531525 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 8 : u32 > as λ([Field; 8], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field, 6 : Field, 7 : Field, 8 : Field], 8 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 10105395258059943854471547573391327707179901153940064586773125525172385465411 : Field, -7764172381957047914625405480055519449068901615240110013280942913930205438090 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 9 : u32 > as λ([Field; 9], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field, 6 : Field, 7 : Field, 8 : Field, 9 : Field], 9 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { 4630760469979870165820917922898436050077118370325830990580986530746633543789 : Field, 445421188486227550820408419830973545028032672242093648088931561027838255858 : Field, false })) : Unit;
    ...
    #assert(((embedded_curve_ops::EmbeddedCurvePoint<  > as Eq<  >)::eq<  > as λ(embedded_curve_ops::EmbeddedCurvePoint<  >, embedded_curve_ops::EmbeddedCurvePoint<  >) → bool)((@std::hash::pedersen_commitment_with_separator< 10 : u32 > as λ([Field; 10], u32) → embedded_curve_ops::EmbeddedCurvePoint<  >)([1 : Field, 2 : Field, 3 : Field, 4 : Field, 5 : Field, 6 : Field, 7 : Field, 8 : Field, 9 : Field, 10 : Field], 10 : u32), embedded_curve_ops::EmbeddedCurvePoint<  > { -311556882567474412576811669014419164866085063813982345701073780395111226613 : Field, -163948955461070038478898748306472919392980231474444415480716967232318545340 : Field, false })) : Unit;
}
