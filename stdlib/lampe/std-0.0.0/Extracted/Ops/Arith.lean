...
noir_trait_impl[impl_181]<> std::ops::arith::WrappingSub<> for i8 where [] := {
  noir_def wrapping_sub<>(self: i8, y: i8) -> i8 := {
    (#_cast returning i8)((ops::arith::wrapping_sub_hlp< i8> as λ(i8, i8) -> Field)(self, y))
  };
}

noir_trait_impl[impl_182]<> std::ops::arith::WrappingSub<> for i16 where [] := {
  noir_def wrapping_sub<>(self: i16, y: i16) -> i16 := {
    (#_cast returning i16)((ops::arith::wrapping_sub_hlp< i16> as λ(i16, i16) -> Field)(self, y))
  };
}

noir_trait_impl[impl_183]<> std::ops::arith::WrappingSub<> for i32 where [] := {
  noir_def wrapping_sub<>(self: i32, y: i32) -> i32 := {
    (#_cast returning i32)((ops::arith::wrapping_sub_hlp< i32> as λ(i32, i32) -> Field)(self, y))
  };
}

noir_trait_impl[impl_184]<> std::ops::arith::WrappingSub<> for i64 where [] := {
  noir_def wrapping_sub<>(self: i64, y: i64) -> i64 := {
    (#_cast returning i64)((ops::arith::wrapping_sub_hlp< i64> as λ(i64, i64) -> Field)(self, y))
  };
}

noir_trait_impl[impl_185]<> std::ops::arith::WrappingSub<> for Field where [] := {
  noir_def wrapping_sub<>(self: Field, y: Field) -> Field := {
    (#_fSub returning Field)(self, y)
  };
}

noir_trait_impl[impl_186]<> std::ops::arith::WrappingMul<> for u1 where [] := {
  noir_def wrapping_mul<>(self: u1, y: u1) -> u1 := {
    (#_uAnd returning u1)(self, y)
  };
}

noir_trait_impl[impl_187]<> std::ops::arith::WrappingMul<> for u8 where [] := {
  noir_def wrapping_mul<>(self: u8, y: u8) -> u8 := {
    (ops::arith::wrapping_mul_hlp<u8> as λ(u8, u8) -> u8)(self, y)
  };
}

noir_trait_impl[impl_188]<> std::ops::arith::WrappingMul<> for u16 where [] := {
  noir_def wrapping_mul<>(self: u16, y: u16) -> u16 := {
    (ops::arith::wrapping_mul_hlp<u16> as λ(u16, u16) -> u16)(self, y)
  };
}

noir_trait_impl[impl_189]<> std::ops::arith::WrappingMul<> for u32 where [] := {
  noir_def wrapping_mul<>(self: u32, y: u32) -> u32 := {
    (ops::arith::wrapping_mul_hlp<u32> as λ(u32, u32) -> u32)(self, y)
  };
}

noir_trait_impl[impl_190]<> std::ops::arith::WrappingMul<> for u64 where [] := {
  noir_def wrapping_mul<>(self: u64, y: u64) -> u64 := {
    (ops::arith::wrapping_mul_hlp<u64> as λ(u64, u64) -> u64)(self, y)
  };
}

noir_trait_impl[impl_191]<> std::ops::arith::WrappingMul<> for i8 where [] := {
  noir_def wrapping_mul<>(self: i8, y: i8) -> i8 := {
    (ops::arith::wrapping_mul_hlp< i8> as λ(i8, i8) -> i8)(self, y)
  };
}

noir_trait_impl[impl_192]<> std::ops::arith::WrappingMul<> for i16 where [] := {
  noir_def wrapping_mul<>(self: i16, y: i16) -> i16 := {
    (ops::arith::wrapping_mul_hlp< i16> as λ(i16, i16) -> i16)(self, y)
  };
}

noir_trait_impl[impl_193]<> std::ops::arith::WrappingMul<> for i32 where [] := {
  noir_def wrapping_mul<>(self: i32, y: i32) -> i32 := {
    (ops::arith::wrapping_mul_hlp< i32> as λ(i32, i32) -> i32)(self, y)
  };
}

noir_trait_impl[impl_194]<> std::ops::arith::WrappingMul<> for i64 where [] := {
  noir_def wrapping_mul<>(self: i64, y: i64) -> i64 := {
    (ops::arith::wrapping_mul_hlp< i64> as λ(i64, i64) -> i64)(self, y)
  };
}

noir_trait_impl[impl_195]<> std::ops::arith::WrappingMul<> for u128 where [] := {
  noir_def wrapping_mul<>(self: u128, y: u128) -> u128 := {
    (ops::arith::wrapping_mul128_hlp<> as λ(u128, u128) -> u128)(self, y)
  };
}

noir_trait_impl[impl_196]<> std::ops::arith::WrappingMul<> for Field where [] := {
