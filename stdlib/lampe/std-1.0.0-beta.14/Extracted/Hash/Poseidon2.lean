...
noir_def «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::hash<N: u32>(input: Array<Field, N: u32>, message_size: u32) -> Field := {
  («std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::hash_internal<N: u32> as λ(Array<Field, N: u32>, u32, bool) -> Field)(input, message_size, (#_uNeq returning bool)(message_size, uConst!(N: u32)))
}
...
noir_def «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::perform_duplex<>(self: & «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>) -> Unit := {
  for i in (0: u32) .. («std-1.0.0-beta.14»::hash::poseidon2::RATE<> as λ() -> u32)() do {
    if (#_uLt returning bool)(i, (#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).2) then {
      (((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).1: Array<Field, 4: u32>)[i]: Field) = (#_fAdd returning Field)((#_arrayIndex returning Field)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).1, (#_cast returning u32)(i)), (#_arrayIndex returning Field)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).0, (#_cast returning u32)(i)));
      #_skip
    }
  };
  ((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).1: Array<Field, 4: u32>) = (#_poseidon2Permutation returning Array<Field, 4: u32>)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).1);
  #_skip
}

noir_def «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::absorb<>(self: & «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>, input: Field) -> Unit := {
  (#_assert returning Unit)((#_bNot returning bool)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).3));
  if (#_uEq returning bool)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).2, («std-1.0.0-beta.14»::hash::poseidon2::RATE<> as λ() -> u32)()) then {
    («std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::perform_duplex<> as λ(& «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>) -> Unit)(self);
    (((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).0: Array<Field, 3: u32>)[(0: u32)]: Field) = input;
    ((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).2: u32) = (1: u32);
    #_skip
  } else {
    {
      let i_2755 = (#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).2;
      (((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).0: Array<Field, 3: u32>)[i_2755]: Field) = input;
      #_skip
    };
    ((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).2: u32) = (#_uAdd returning u32)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).2, (1: u32));
    #_skip
  }
}

noir_def «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::squeeze<>(self: & «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>) -> Field := {
  (#_assert returning Unit)((#_bNot returning bool)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).3));
  («std-1.0.0-beta.14»::hash::poseidon2::Poseidon2::perform_duplex<> as λ(& «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>) -> Unit)(self);
  ((*self: «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>).3: bool) = #_true;
  (#_arrayIndex returning Field)((#_readRef returning «std-1.0.0-beta.14»::hash::poseidon2::Poseidon2<>)(self).1, (0: u32))
}
...
def «std-1.0.0-beta.14».Hash.Poseidon2.env : Env := Env.mk
  [«std-1.0.0-beta.14::hash::poseidon2::RATE», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::hash», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::new», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::perform_duplex», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::absorb», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::squeeze», «std-1.0.0-beta.14::hash::poseidon2::Poseidon2::hash_internal»]
  [«std-1.0.0-beta.14».impl_0, «std-1.0.0-beta.14».impl_1]
