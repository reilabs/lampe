...
noir_global_def hello: String<16: u32> = "hello-git-dep-v1";

noir_global_def hello_git_dep_v1: String<16: u32> = "hello-git-dep-v1";
...
def Lib.env : Env := Env.mk
  [not_equal, hello, hello_git_dep_v1, test_not_equal]
  []
