...
noir_def «skyscraper-0.0.0»::bar::bar<>(a: Field) -> Field := {
  ...
  let new_bytes_array = («std-1.0.0-beta.14»::vector::as_array<u8, 32: u32> as λ(Vector<u8>) -> Array<u8, 32: u32>)(new_bytes);
