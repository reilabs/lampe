...
noir_def «Merkle-0.0.0»::mtree_recover<H: Type, N: u32>(idx: Array<bool, N: u32>, p: Array<Field, N: u32>, item: Field) -> Field := {
  ...
  for i in (0: u32) .. uConst!(N: u32) do {
    ...
    if dir then {
      curr_h = ((H as «hasher-0.0.0»::BinaryHasher<Field>)::hash<> as λ(Field, Field) -> Field)(sibling_root, (#_readRef returning Field)(curr_h));
      #_skip
    } else {
      curr_h = ((H as «hasher-0.0.0»::BinaryHasher<Field>)::hash<> as λ(Field, Field) -> Field)((#_readRef returning Field)(curr_h), sibling_root);
      #_skip
    }
  };
...
noir_def «Merkle-0.0.0»::main<>(root: Field, proof: Array<Field, 32: u32>, item: Field, idx: Array<bool, 32: u32>) -> Unit := {
  let calculated_root = («Merkle-0.0.0»::mtree_recover<«skyscraper-0.0.0»::Skyscraper<>, 32: u32> as λ(Array<bool, 32: u32>, Array<Field, 32: u32>, Field) -> Field)(idx, proof, item);
